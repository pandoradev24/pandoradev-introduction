        ...
        <div className="mx-auto basis-[66.66%] max-w-[66.66%]">
          <div className="py-4 flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
              <li>
                ...
                luôn lắng nghe và truyền đạt ý kiến một cách rõ ràng, sử dụng từ
                ngữ tích cực và mang tính xây dựng đến tránh gây hiểu lầm.
              </li>
              <li>Chủ động cập nhật thông tin và tiến độ công việc.</li>
              <li>
                Hỗ trợ việc chia sẻ thông tin, kinh nghiệm và kiến thức giữa các
                thành viên nhóm.
              </li>
            </ul>
          </div>
          <div className="py-4 flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
              ...
              <li>
                Trong quá trình hoàn thiện bài làm, nếu gặp nhiều khó khăn, các
                thành viên trong nhóm có thể đề xuất thêm một buổi họp online
                vào tối thứ bảy ở Google Meet.
              </li>
          ...
          <div className="py-4 flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
              <li>
                Hoàn thành tốt công việc được phân công xuyên suốt quá trình làm
                bài.
              </li>
              <li>Có những đóng góp lớn, mang tính xây dựng cho nhóm.</li>
              <li>
                <strong>Hình thức thưởng: </strong>Một cái bánh trung thu đến từ
                Bảo Hoàng.
              </li>
            </ul>
            ...
            <ul className="list-disc list-outside text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
              ...
              <li>
                <strong>Hình thức phạt: </strong>Cảnh cáo, trừ điểm, báo cáo với
                giáo viên, loại ra khỏi nhóm.
              </li>
            </ul>
          </div>
          <div className="py-4 flex flex-col gap-4">
            ...
            <ul className="list-disc list-outside text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
              <li>
                Nhóm trưởng sẽ tạo form đánh giá cá nhân ở Google biểu mẫu. Các
                thành viên sẽ nhận được nó vào tối Chủ nhật tuần trước deadline.
                Mỗi thành viên sẽ tự đánh giá mức độ hoàn thành công việc của
                chính bản thân, đồng thời đánh giá mức độ hoàn thành công việc
                  ...
                  <ul className="ml-6 mt-2 text-[#333] text-[1.25rem] text-justify font-semibold leading-[1.7] flex flex-col gap-y-2">
                    <li>
                      <div className="flex flex-row items-center">
                        ...
                        : Chủ động hoàn thành công việc ở mức xuất sắc, có những
                        đóng góp nổi trội cho đồ án.
                      </div>
                    </li>
                    <li>
                      <div className="flex flex-row items-center">
                    ...
                    <li>
                      <div className="flex flex-row items-center">
                        ...
                        : Hoàn thành vừa đủ công việc, có nhiều thiếu sót trong
                        nội dung, bài làm.
                      </div>
                    </li>
                    <li>
